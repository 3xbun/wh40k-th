---
dg-publish: true
dg-permalink: "Core Rules/Core Concept"
---
...
> ข้อมูลพื้นฐานและความสามารถของโมเดลภายในเกมจะระบุไว้ใน Data Sheet ของ แต่ละยูนิตจะมี Data Sheet เป็นของตัวเอง คุณจะต้องมี Data Sheet ของ ทุกยูนิตที่อยู่ในกองทัพของคุณ คุณสามารถหาข้อมูลเพิ่มเติมเกี่ยวกับ Data Sheet ได้ที่[[แผ่นข้อมูล]]
>
> **คําสำคัญ - KEYWORDS**
...
> 
> แนวรบใน Warhammer 40,000 สามารถใช้โมเดลจาก Warhammer 40,000 โมเดลเหล่านี้เรียกว่า Terrain เพื่อแยกความแตกต่างจากโมเดลที่ประกอบขึ้นเป็นกองทัพ Terrain จะถูกวางไว้บนสนามรบก่อนเกมจะเริ่มต้น คุณสามารถหาข้อมูลเพิ่มเติมเกี่ยวกับ Terrain ได้ที่ [[ภูมิประเทศ]]
> 
